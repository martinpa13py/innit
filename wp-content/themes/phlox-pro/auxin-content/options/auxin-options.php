...
function auxin_define_options_info( $fields_sections_list ){
    ...
    $options[] = array(
        'title'       => __( 'Override elementor container size', 'phlox-pro' ),
        'description' => __( 'Enable this option so that customizer max-width option override elementor settings.', 'phlox-pro' ),
